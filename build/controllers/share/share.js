...
// const share = async (req: AuthenticatedRequest, res: Response): Promise<void> => {
...
//         return;
//       }
//       const username = typeof reel.user === 'object' && 'username' in reel.user ? reel.user.username : 'Unknown User';
//       title = `Watch this amazing reel by ${username} on Reelzzz`;
